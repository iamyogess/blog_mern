  ...
  return (
    <section className="container mx-auto flex flex-col px-5 py-5 lg:flex-row">
      ...
      <div className="mt-10 lg:w-1/2">
        <h1 className="font-roboto text-center font-bold text-3xl text-dark-soft md:text-5xl lg:text-4xl xl:text-5xl lg:text-left lg:max-w-[540px]">
          Read the most interesting articles
        </h1>
        <p className="text-dark-light mt-4 text-center md:text-xl lg:text-base xl-text-xl lg:text-left">
          Lorem ipsum dolor sit, amet consectetur adipisicing elit. Magnam,
          tempora ipsam. Cumque illo accusantium earum.
        </p>
        ...
        <div className="flex flex-col gap-y-2.5 mt-10 relative">
          ...
          <button className="w-full bg-primary text-white font-semibold rounded-lg px-5 py-3 mt-6 md:my-0 md:absolute md:right-2 md:top-1/2 -translate-y-1/2 md:w-fit md:py-2">
            Search
          </button>
        </div>
